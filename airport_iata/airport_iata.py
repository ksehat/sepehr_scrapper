...
def get_iata_code(airport_name):
    airport_dict = {
        'Airport name': {0: 'مهرآباد', 1: 'مشهد', 2: 'شیراز', 3: 'تبريز', 4: 'اصفهان', 5: 'اهواز', 6: 'بوشهر',
                         7: 'کرمان',
                         ...
                         28: 'شاهرود', 29: 'نوشهر', 30: 'ياسوج', 31: 'زنجان', 32: 'اراک', 33: 'زابل', 34:'یاسوج'},
        'IATA code': {0: 'THR', 1: 'MHD', 2: 'SYZ', 3: 'TBZ', 4: 'IFN', 5: 'AWZ', 6: 'BUZ', 7: 'KER', 8: 'SRY',
                      ...
                      28: 'SHD', 29: 'NSA', 30: 'YJK', 31: 'ZJN', 32: 'AJK', 33: 'ZBL', 34: 'YJK'}}
